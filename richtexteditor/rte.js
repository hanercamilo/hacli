...
(function () {
    ...
    function ch(b, c) {
        return function (h, g) {
            ...
            if (c._) {
                var f = c._[a[124]]();
                return { width: d[a[125]], height: d[a[25]], left: qm(f[a[78]], d[a[78]]), top: qm(f[a[80]], d[a[80]]), right: qm(d[a[282]], f[a[78]]), bottom: qm(d[a[235]], f[a[80]]) };
            } else {
                return d;
            }
        };
    ...
    function zZ(d, f, h, l, g, b, j, c, k, m) {
        f._[d._] = g._[qm(h._ + a[465], l._)] = { rowindex: h._, colindex: b._, rowspan: j._, colspan: c._, td: k._, tr: m._, tdindex: l._, spannodes: null };
    }
    function Aa(b, a) {
        if (qv(b._, a._)) {
        }
        ...
        for (d._ = 0; qp(d._, c._); d._ += 3) {
            ...
            for (b._ = j._[d._]; qh(b._, a._); b._ += h._) {
                ...
                k._ = qx(
                    v._,
                    qg(
                        qg(qg(qg(o._[qk(qw(l._, 24), 0x3f)], q._[qk(qw(l._, 16), 0x3f)]) | s._[qk(qw(l._, 8), 0x3f)], u._[qk(l._, 0x3f)]) | n._[qk(qw(m._, 24), 0x3f)], p._[qk(qw(m._, 16), 0x3f)]) | r._[qk(qw(m._, 8), 0x3f)],
                        t._[qk(m._, 0x3f)]
                    )
                );
            }
